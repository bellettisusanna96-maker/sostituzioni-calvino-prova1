...
<style>
    ...
    /* 2. Personalizzazione Selectbox: Nome/Giorno SELEZIONATO GRANDE, Opzioni nel menu a tendina NORMALI */
    ...
    /* Testo del Nome/Giorno SELEZIONATO nella casella (PIÙ GRANDE) */
    ...
    /* OPZIONI ALL'INTERNO DELLA TENDINA APERTA (DIMENSIONE NORMALE / NON TROPPO GRANDE) */
    ...
    /* Spaziatura standard e ordinata per ciascuna voce del menu a tendina aperto */
    li[data-baseweb="option"],
    [role="option"] {
