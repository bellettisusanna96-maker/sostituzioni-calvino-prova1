...
st.markdown("""
<style>
    /* 1. Stile perfettamente bilanciato per far rientrare tutte e 3 le pagine (Tab) affiancate nella schermata */
    ...
    /* 2. Ingrandimento per TUTTI i Selectbox e relative tendine (Pop-over Dropdown) */
    ...
    /* Voci del menu a tendina aperto (BaseWeb Dropdown / Popover) */
