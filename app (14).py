...
def save_data_to_gsheets():
    ...
    try:
        ...
        st.sidebar.error(f"⚠️ Errore salvataggio Google Fogli: {e}")
        return False
...
if gsheets_connected:
    ...
    if st.sidebar.button("🔄 Sincronizza / Ricarica da Cloud"):
        if load_data_from_gsheets():
            ...
            st.sidebar.error("Errore durante la lettura da Google Fogli.")
else:
...
with tab_assenze:
    ...
    with col_add3:
        ...
        # VERIFICA SE IL DOCENTE SELEZIONATO È GIÀ STATO ASSEGNATO COME SUPPLENTE
        ...
        # AVVISO IN EVIDENZA SE IL DOCENTE È GIÀ STATO SEGNATO COME SUPPLENTE
...
with tab_registro:
    ...
    if reg_giorno:
        ...
        # Aggiunta indicatore di stato del sostituto
        stati_sost = []
