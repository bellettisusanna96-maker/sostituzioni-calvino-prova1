...
<style>
    ...
    /* 2. Selezione Giorno e Docenti: UNIFORMIZZAZIONE PERFETTA DEL FONT */
    ...
    /* Testo SELEZIONATO nella casella del Selectbox (stessa dimensione esatta della tendina) */
    ...
    /* Opzioni dentro la tendina aperta (Popover Dropdown) - Identica dimensione (1.25rem / 20px) */
