...
st.subheader("Sistema Automatico Gestione Sostituzioni e Supplenze - Modulo Gestione Settimanale e Storico Assenze (A.S. 2026/2027 - v30)")
...
# Calcolo avanzamento coperture del giorno selezionato
tot_scop_g = 0
in_sosp_g = 0
confl_g = 0
