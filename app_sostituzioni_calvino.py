...
<style>
    ...
    /* 2. Ingrandimento MASSIMO per TUTTI i Selectbox e le tendine aperte (Pop-over Dropdown) */
    ...
    /* Testo selezionato dentro la casella chiusa */
    ...
    /* VOCI DEL MENU A TENDINA APERTO (LISTA DI SELEZIONE GIORNI E DOCENTI) */
    ...
    /* Spaziatura e altezza riga per ogni opzione nel menu a tendina aperto */
    li[data-baseweb="option"],
    [role="option"] {
    ...
    /* Evidenziazione elemento al passaggio del mouse o selezionato nel menu */
