...
st.subheader("Sistema Automatico Gestione Sostituzioni e Supplenze - Modulo Gestione Settimanale e Storico Assenze (A.S. 2026/2027 - v31)")
...
# 2. IMPORTAZIONE BACKUP CSV
st.sidebar.markdown("---")
st.sidebar.header("📥 2. Importazione Backup")
...
# 3. SALVATAGGIO CLOUD GOOGLE FOGLI
st.sidebar.markdown("---")
st.sidebar.header("📊 3. Salvataggio Cloud")
...
with c_day2:
    # 1. Avviso relativo al giorno selezionato
    if tot_scop_g > 0:
    ...
    # 2. Avviso relativo al quadro generale della settimana
